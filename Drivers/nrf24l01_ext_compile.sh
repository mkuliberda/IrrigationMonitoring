...
g++ -shared -Wl,--export-dynamic nrf24l01_test.o nrf24l01_test_wrapper.o -L/usr/lib -lboost_python -L/usr/lib/python2.7/config-arm-linux-gnueabihf -lpython2.7 -o nrf24l01_ext.so
